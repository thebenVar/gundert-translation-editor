$issues = @(
    @{ title = "GH-011 FR-01 Database schema"; body = "Implement complete database schema for resources, entries, translations, feedback, and user management.`n`nSee Mermaid ERD in PRD-001." },
...
foreach ($issue in $issues) {
    ...
    gh issue create -t $issue.title -b $issue.body 2>&1 | Select-Object -First 1
